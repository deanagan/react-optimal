...
export default {
  ...
  data() {
    return {
      whatUseState: [
        "Has a lazy loading form which runs only on first call",
        "Has a functional update form in the setValue that can be used if current number is computed off the previous number",
      ],
      sandboxlink:
